# Blackletter — Análisis de Producto-Mercado

## Lo que tienes hoy

Blackletter es una plataforma SaaS de gestión inteligente de contratos con:
...
1. **IA que extrae, no que chatea:** A diferencia de ChatGPT (que el 82,5% ya usa de forma genérica), Blackletter extrae datos estructurados del contrato automáticamente — fechas, partes, cláusulas, plazos de terminación. No requiere prompts.
