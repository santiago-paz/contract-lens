          ...
          <div className="bg-white border-2 border-black shadow-[8px_8px_0px_0px_#000] p-0 flex flex-col relative overflow-hidden bg-noise">
            ...
            <div className="flex items-center justify-between border-b-2 border-black p-3 bg-black text-white">
              <div className="flex items-center gap-2">
                <div className="w-2 h-2 bg-[#CCFF00]" aria-hidden="true"></div>
              ...
              <button
                ...
                className="hover:bg-[#CCFF00] hover:text-black transition-colors p-1 border border-transparent hover:border-black focus-visible:outline-white"
              >
            ...
            <div className="flex gap-5 p-5">
              ...
              <p className="font-mono text-xs text-black leading-relaxed font-medium">
