      ...
      <div className="mx-auto max-w-[1200px] px-6">
        <div className="flex flex-col gap-10 py-14 md:flex-row md:items-start md:justify-between">
          <div className="max-w-sm">
            <Brand />
            <p className="mt-4 text-copy text-muted">{t.footer.tagline}</p>
          </div>

          <div className="grid grid-cols-2 gap-x-12 gap-y-3 text-row">
        ...
        <div className="flex flex-col gap-4 border-t border-rule py-5 text-small text-muted sm:flex-row sm:items-center sm:justify-between">
          <span>
