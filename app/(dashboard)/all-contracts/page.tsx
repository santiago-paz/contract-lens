  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-3xl font-black text-black uppercase tracking-tight">All Contracts</h1>
          <p className="text-gray-500 text-sm mt-1 uppercase font-medium">All contracts across your organization</p>
        </div>
        <Link
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-gray-50 border-b border-gray-200">
                  ...
                  <th className="px-6 py-3 text-[10px] font-bold text-gray-500 uppercase tracking-wider">Created By</th>
          ...
          <div className="flex flex-col items-center justify-center p-16 text-center">
            ...
            {q || status ? (
              ...
              <>
                ...
                <p className="text-gray-500 mb-6 max-w-xs text-xs">No one in the organization has created a contract yet.</p>
                <Link
                  href="/contract-creator"
                  className="inline-flex items-center gap-2 px-4 py-2 bg-black text-white border border-black shadow-hard hover:translate-x-[2px] hover:translate-y-[2px] hover:shadow-none transition-all active:bg-[#CCFF00] active:text-black group"
                >
