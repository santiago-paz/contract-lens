    ...
    <div className="min-h-screen bg-gray-50 flex flex-col font-sans">
      ...
      <header className="bg-white border-b px-6 py-4 flex items-center justify-between sticky top-0 z-50 shadow-sm/50 backdrop-blur-sm bg-white/90">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-bold text-gray-900 tracking-tight leading-none">Split-Berlin</h1>
            <p className="text-xs text-gray-500 font-medium mt-1">Editor de Contratos Estructurados</p>
          </div>
        </div>
